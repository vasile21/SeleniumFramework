		...
		switch (BROWSER)
		{
			...
			case "chrome":
				if (driver == null || ((ChromeDriver) driver).getSessionId() == null)
				{
					...
					//make sure this folder has proper access (writing and reading rights)
					final String downloadFilepath = PropertiesConfig.getProperty(PropertiesKeys.DOWNLOAD_PATH);
